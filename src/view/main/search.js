          ...
          icon: {
            component:
              <>
                ...
                <FastImage source={{ uri: item.photos[0] }} defaultSource={theme == 'dark' ? require('../../assets/img/watermark-dark.png') : require('../../assets/img/watermark.png')} resizeMode="cover" style={[{ width: 62, height: 62, borderRadius: 10 }]} />
              </>
          },
          component:
            <Item
